...
# We'll define the conversion function here to avoid external file dependency
# (but we could also import from a utils module if we wanted to reuse)
try:
    import markdown2
except ImportError:
    # This should be caught at startup via requirements, but just in case
    markdown2 = None

markdown_bp = Blueprint("markdown", __name__)

# Predefined themes as CSS strings (copied from md2html.py)
THEMES = {
    "light": """
/* Light Theme */
body {
